...
<body>
    <form method="post" action="login_db_teacher.php">
                ...
                <div class="container">
                    <div class="signin-content">
                        ...
                        <div class="signin-form">
                            <center>
                                <h2 class="form-title">ลงชื่อเข้าใช้อาจารย์</h2>
                            </center>

                            <div class="form-group">
                                    <label for="your_name"></label>
                                    <input type="text" name="your_name" id="your_name" placeholder="รหัสอาจารย์" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group form-button">
                                    <center><input type="submit" name="signin" id="signin" class="form-submit1"
                                            value="เข้าสู่ระบบ" /></center>
                                </div>
